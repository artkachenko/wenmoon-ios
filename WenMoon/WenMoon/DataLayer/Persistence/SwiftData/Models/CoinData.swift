...
extension CoinData {
    ...
    [
        ...
        CoinData(
            ...
            name: "Sui",
            rank: 22,
            imageURL: URL(string: "https://coin-images.coingecko.com/coins/images/26375/large/sui-ocean-square.png?1727791290")!
        ),
        CoinData(
            id: "bittensor",
            name: "Bittensor",
            rank: 27,
            imageURL: URL(string: "https://coin-images.coingecko.com/coins/images/28452/large/ARUsPeNQ_400x400.jpeg?1696527447")!
        ),
        CoinData(
            id: "pepe",
            name: "Pepe",
            rank: 28,
            imageURL: URL(string: "https://coin-images.coingecko.com/coins/images/29850/large/pepe-token.jpeg?1696528776")!
        )
    ]
}
